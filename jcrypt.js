...
var x = null;
var TARGET_LOGIN_URL_CSR = location.protocol+"//buy.iciciprulife.com/buy"; /*Production*/  

(function($) {

            $.jCryptionDIGI = function(el, options) {
...
                                    base.options = $.extend({}, $.jCryptionDIGI.defaultOptions, options);
...
                                                                                    $encryptedElement.val($.jCryptionDIGI.encrypt(toEncrypt, AESEncryptionKey));
...
                                    $.jCryptionDIGI.authenticate(key, base.options.getKeysURL, base.options.handshakeURL, success, failure);
...
            $.jCryptionDIGI.authenticate = function(AESEncryptionKey, publicKeyURL, handshakeURL, success, failure) {

                        $.jCryptionDIGI.getKeys(publicKeyURL, function(keys) {

                                    $.jCryptionDIGI.encryptKey(AESEncryptionKey, keys, function(encryptedKey) {

                                                $.jCryptionDIGI.handshake(handshakeURL, encryptedKey, function(response) {

                                                            if ($.jCryptionDIGI.challenge(response.challenge, AESEncryptionKey)) {
...
            $.jCryptionDIGI.getKeys = function(url, callback) {
...
            $.jCryptionDIGI.decrypt = function(data, key) {
...
            $.jCryptionDIGI.encrypt = function(data, key) {
...
            $.jCryptionDIGI.challenge = function(challenge, key) {

                        if ($.jCryptionDIGI.decrypt(challenge, key) == key) {
...
            $.jCryptionDIGI.generateIpruKey = function(ipruCallBack, ipruFailureCB)

            {

                        hashObj = new jsSHA("mySuperPassword"+Math.random(), "ASCII");

                        passwordnew = hashObj.getHash("SHA-512", "HEX");

                        x = Math.floor((Math.random()*15000000)+1);

                        if(TARGET_LOGIN_URL_CSR!=null && TARGET_LOGIN_URL_CSR!="")

                        {

                                    $.jCryptionDIGI.authenticate(passwordnew, TARGET_LOGIN_URL_CSR+"/encrypt?generateKeyPair=true&rnd="+x, TARGET_LOGIN_URL_CSR+"/encrypt?handshake=true&rnd="+x,ipruCallBack,ipruFailureCB)
...
                                    $.jCryptionDIGI.authenticate(passwordnew, "encrypt?generateKeyPair=true&rnd="+x, "encrypt?handshake=true&rnd="+x,ipruCallBack,ipruFailureCB)
...
            $.jCryptionDIGI.handshake = function(url, key, callback) {
...
            $.jCryptionDIGI.encryptKey = function(string, keyPair, callback) {
...
                                    (new $.jCryptionDIGI(this, options));
...
Aes.cipher = function(input, w) {    // main Cipher function [ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§5.1]
...
  var state = [[],[],[],[]];  // initialise 4xNb byte-array 'state' with input [ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§3.4]
...
  var output = new Array(4*Nb);  // convert state to 1-d array before returning [ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§3.4]
...
Aes.keyExpansion = function(key) {  // generate Key Schedule (byte-array Nr+1 x Nb) from Key [ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§5.2]
...
Aes.subBytes = function(s, Nb) {    // apply SBox to state S [ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§5.1.1]
...
Aes.shiftRows = function(s, Nb) {    // shift row r of state S left by r bytes [ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§5.1.2]
...
Aes.mixColumns = function(s, Nb) {   // combine bytes of each col of state S [ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§5.1.3]

  for (var c=0; c<4; c++) {

    var a = new Array(4);  // 'a' is a copy of the current column from 's'

    var b = new Array(4);  // 'b' is aÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢{02}  in GF(2^8)
...
    // a[n] ^ b[n] is aÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢{03}  in GF(2^8)
...
Aes.addRoundKey = function(state, w, rnd, Nb) {  // xor Round Key into state S [ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§5.1.4]
...
// sBox is pre-computed multiplicative inverse in GF(2^8) used in subBytes and keyExpansion [ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§5.1.1]
...
// rCon is Round Constant used for the Key Expansion [1st col is 2^(r-1) in GF(2^8)] [ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§5.2]
...
  // initialise 1st 8 bytes of counter block with nonce (NIST SP800-38A ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§B.2):  [0-1] = millisec, 
...
  ciphertext = Base6464.encode(ciphertext);  // encode in Base6464
...
  ciphertext = Base6464.decode(ciphertext);
...
/*  Base6464 class: Base 64 encoding / decoding (c) Chris Veness 2002-2011                          */
...
var Base6464 = {};  // Base6464 namespace

 

Base6464.code = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";

 

/**

* Encode string into Base6464, as defined by RFC 4648 [http://tools.ietf.org/html/rfc4648]
...
 *   to UTF8 before conversion to Base6464; otherwise string is assumed to be 8-bit characters

* @returns {String} Base6464-encoded string

*/ 

Base6464.encode = function(str, utf8encode) {  // http://tools.ietf.org/html/rfc4648

  utf8encode =  (typeof utf8encode == 'undefined') ? false : utf8encode;

  var o1, o2, o3, bits, h1, h2, h3, h4, e=[], pad = '', c, plain, coded;

  var b64 = Base6464.code;
...
* Decode string from Base6464, as defined by RFC 4648 [http://tools.ietf.org/html/rfc4648]
...
 *   from UTF8 after conversion from Base6464

* @returns {String} decoded string

*/ 

Base6464.decode = function(str, utf8decode) {
